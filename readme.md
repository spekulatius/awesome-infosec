...
- [Fonts are still a Helvetica of a Problem](https://www.canva.dev/blog/engineering/fonts-are-still-a-helvetica-of-a-problem/) - Canva Dev-blog covering
  ...
  - [`CVE-2023-45139`](https://nvd.nist.gov/vuln/detail/CVE-2023-45139) - similar to previous one, but in archives of compressed WOFF (ZLIB-based) / WOFF2 (Brotli-based) fonts 
